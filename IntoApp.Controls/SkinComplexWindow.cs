...
namespace IntoApp.Controls
{
    ...
    /// </summary>
    public partial class SkinComplexWindow : Window
    {
        #region 初始化
        public SkinComplexWindow()
        {
        ...
        public double WindowShadowSize
        {
            get
            {
                if (_shadowWindow != null)
                {
                    return _shadowWindow.WindowShadowSize;
                }
                else
                {
            ...
            set
            {
                if (_shadowWindow != null)
                {
                    _shadowWindow.WindowShadowSize = value;
                }
                else
                {
        ...
        public Color WindowShadowColor
        {
            get
            {
                if (_shadowWindow != null)
                {
                    return _shadowWindow.WindowShadowColor;
                }
                else
                {
            ...
            set
            {
                if (_shadowWindow != null)
                {
                    _shadowWindow.WindowShadowColor = value;
                }
                else
                {
        ...
        public Brush WindowShadowBackColor
        {
            get
            {
                if (_shadowWindow != null)
                {
                    return _shadowWindow.WindowShadowBackColor;
                }
                else
                {
            ...
            set
            {
                if (_shadowWindow != null)
                {
                    _shadowWindow.WindowShadowBackColor = value;
                }
                else
                {
