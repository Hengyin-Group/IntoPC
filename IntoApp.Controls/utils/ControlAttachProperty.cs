...
using IntoApp.Controls.Controls;

namespace IntoApp.Controls.utils
{ 
    public static class ControlAttachProperty   //解决PasswordBox不能被继承
    {
        ...
        {
            var button = d as UseButton;//ImageButton
